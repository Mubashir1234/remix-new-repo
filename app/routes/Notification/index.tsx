        ...
        <div className="grid container  min-h-[85vh] p-2">
          <div className="grid grid-cols-12 gap-2 pt-6 h-full">
            ...
            <div className="col-span-12 md:col-span-12 lg:col-span-9 h-full p-2">
              ...
              <p className="font-inter text-3xl font-bold leading-9 text-left pb-5">Notificaciones</p>
              ...
              <Card>
                <div className="grid grid-cols-12 gap-2  h-full  pr-6 pl-6 pb-6">
                  ...
                  <div className="col-span-8 md:col-span-8 lg:col-span-9 pt-5 ">
                    <p className="font-inter font-medium text-xl leading-6 pb-2">Notificaciones push de escritorio</p>
                    <p className="font-inter text-[#686868] leading-5">Reciba notificaciones automáticas sobre alertas y mensajes inmediatamente en su aplicación de escritorio.</p>
                  </div>
                  <div className="col-span-4 md:col-span-4 lg:col-span-3 flex justify-end items-center">
                    <input type="checkbox" value="true" className="sr-only peer" checked={false} />
                    <div onClick={()=>console.log("hello")} className="relative w-11 h-6 bg-gray-200 peer-focus:outline-none peer-focus:ring-4 peer-focus:ring-blue-300 dark:peer-focus:ring-blue-800 rounded-full peer dark:bg-gray-700 peer-checked:after:translate-x-full rtl:peer-checked:after:-translate-x-full peer-checked:after:border-white after:content-[''] after:absolute after:top-[2px] after:start-[2px] after:bg-white after:border-gray-300 after:border after:rounded-full after:h-5 after:w-5 after:transition-all dark:border-gray-600 peer-checked:bg-black"></div>
                  </div>
                </div>
                <div className="grid grid-cols-12 gap-2  h-full  pr-6 pl-6 pb-6">
                  <div className="col-span-8 md:col-span-8 lg:col-span-9 pt-5 ">
                    <p className="font-inter font-medium text-xl leading-6 pb-2">Actividad en tu espacio de trabajo</p>
                    <p className="font-inter text-[#686868] leading-5">Reciba correos electrónicos cuando reciba comentarios, menciones, alertas, recordatorios, solicitudes de acceso y cambios de propiedad.</p>
                  </div>
                  <div className="col-span-4 md:col-span-4 lg:col-span-3 flex justify-end items-center">
                ...
                <div className="grid grid-cols-12 gap-2  h-full  pr-6 pl-6 pb-6">
                  <div className="col-span-8 md:col-span-8 lg:col-span-9 pt-5 ">
                    <p className="font-inter font-medium text-xl leading-6 pb-2">Anuncios y actualizaciones</p>
                    <p className="font-inter text-[#686868] leading-5">Reciba correos electrónicos ocasionales sobre lanzamientos de productos y nuevas funciones de BlackfishID.</p>
                  </div>
                  <div className="col-span-4 md:col-span-4 lg:col-span-3 flex justify-end items-center">
